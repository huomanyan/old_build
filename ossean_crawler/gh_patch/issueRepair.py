...
def getIssueCountSea(offset,batchsize):
    ...
    insert_sql = "update ossean_issues_repair_patch set incre_sea = %d where id = %d"
...
def IssuesRepair(offset,batchsize):
    ...
    insert_sql = "insert into ossean_issues_repair_patch(id, s3_issue_count, s3_issue_time, s4_issue_count, s4_issue_time) VALUES (%d,%d,%d,%d,%d)"
    src_repo_list = getRepoUrlList(offset,batchsize)
