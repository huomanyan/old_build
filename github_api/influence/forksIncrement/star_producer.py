...
conn = pymysql.connect(host="127.0.0.1",user="root",passwd="123456",db="github",charset='utf8mb4' )
#conn = pymysql.connect(host="127.0.0.1",user="root",passwd="a123456",db="gitlab",charset='utf8' )
conn.autocommit(1)
cursor = conn.cursor()
forks_select="select id,url from dapp_repos where forks_flag is null"
r.delete('star_set')
def start():
